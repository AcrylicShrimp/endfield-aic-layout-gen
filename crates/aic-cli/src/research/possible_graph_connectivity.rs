...
fn render_summary(report: &PossibleGraphConnectivityDiagnosisReport) -> Result<String> {
    let rows = report
        ...
        .map(|case| {
            ...
            format!(
                "<tr><td><a href=\"{name}.html\">{:?}</a></td><td>{:?}</td><td>{}</td><td>{}</td><td>{}</td><td>{}</td><td>{}</td><td>{}</td><td>{}</td><td>{}</td><td>{}</td><td>{}</td><td>{}</td><td>{}</td><td>{}</td><td>{}</td><td>{}</td><td>{}</td><td>{}</td><td>{}</td><td>{}</td><td>{}</td><td>{}</td><td>{}</td><td>{}</td><td>{}</td><td>{}</td><td>{}</td><td>{}</td><td>{}</td><td>{}</td><td>{}</td><td>{}</td><td>{}</td><td>{}</td><td>{}</td><td>{}</td><td>{}</td></tr>",
                case.kind,
                case.outcome,
                ...
                grid.forced_predicate_attempts,
                grid.forcing_conflicts,
                grid.maximum_reason_predicates,
