...
pub use report::{
    ...
    ExperimentStrategyIdentity, FactorGraphMetrics, FamilyIncidenceMetrics, FormulationIdentity,
    GraphStructureMetrics, IrComplexityMetrics, MetricCoverage, ModelComplexityMetrics,
    ModelEstimateError, ObjectiveKind, ObjectiveStageObservation, ObjectiveValue,
    PhaseFormulationEstimate, PhaseGrowthMetrics, ProofStatus, ResourceObservation,
    SEARCH_SPACE_ANALYSIS_SCHEMA_VERSION, SearchSpaceAnalysisReport, SolveObservation, SolveStatus,
    StaticSearchSpaceAnalysis, StrategyClassification, SymmetryGroupMetrics, SymmetryMetrics,
