...
pub use integrated::{
    ...
    ParallelExactDimensionSweepReport, PhysicalOccupancyCaseReport,
    ...
    solve_integrated_layout_with_time_limit, sweep_first_integrated_layout_phase_fixed_dimensions,
};
