...
pub use integrated::{
    ...
    RootDomainCardinality, RootDomainSnapshot, RootExternalGeometrySnapshot,
    RootFacilityStateSnapshot, RootFirstDecisionSnapshot, RootFlowDomainCounts,
    RootMaterialNetworkSnapshot, RootTerminalDomainSnapshot, RootTransportLayerSnapshot,
    RootVariableCoverageSnapshot, RootVariableFamilySnapshot, RouteCellBreakdownCaseReport,
    ...
    SharedLayerComparisonReport, TRANSPORT_TILE_CAP_DIAGNOSIS_SCHEMA_VERSION, TransportNetwork,
