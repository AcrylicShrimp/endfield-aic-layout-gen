...
pub use integrated::{
    ...
    CUMULATIVE_FACILITY_COORDINATE_PARTITION_SCHEMA_VERSION, CUMULATIVE_SCC_GROWTH_SCHEMA_VERSION,
    ...
    FacilityCoordinateCaseReport, FactoredEndpointComparisonReport,
    ...
    diagnose_cumulative_facility_coordinate_partitions, render_integrated_layout_html,
