...
pub use integrated::{
    ...
    ResidualFacilityStateCaseReport, RootBooleanDomainCounts, RootDomainCardinality,
    RootDomainSnapshot, RootExternalGeometrySnapshot, RootFacilityStateSnapshot,
