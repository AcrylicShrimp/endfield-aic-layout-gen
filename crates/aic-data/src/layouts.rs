...
pub use integrated::{
    ...
    ExactDimensionSolverStack, ExactDimensionUpperBoundImprovement, ExactModelMetrics,
    ...
    ExactValidationStatus, ExternalBoundaryCellCaseReport, ExternalBoundaryCellPartitionReport,
