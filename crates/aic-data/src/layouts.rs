...
pub use integrated::{
    ...
    FactoredEndpointComparisonReport, INTEGRATED_LAYOUT_SCHEMA_VERSION, IntegratedLayoutDiagnostic,
    IntegratedLayoutPhase, IntegratedLayoutReport, IntegratedLayoutStatus,
    PlacedLogisticsComponent, SHARED_LAYER_COMPARISON_SCHEMA_VERSION, SharedLayerComparisonReport,
