...
pub use research::{
    ...
    ExactDimensionPartitionCaseReport, ExactDimensionUpperBoundImprovement,
    ...
    FactoredRequirementSubsetCaseReport, PARALLEL_EXACT_DIMENSION_SWEEP_SCHEMA_VERSION,
