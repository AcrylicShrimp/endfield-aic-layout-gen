...
pub use research::{
    ...
    GuardedCoreInitialGateReport, GuardedCoreInitialGateStatus, GuardedItemIntersectionObservation,
    LayerGridAnalyzerRuntime, MATERIAL_JUNCTION_CONTINUATION_SCHEMA_VERSION,
    ...
    MaterialSeparatorCutReport, PARALLEL_EXACT_DIMENSION_SWEEP_SCHEMA_VERSION,
    PHASE2_REFERENCE_ABLATION_SCHEMA_VERSION, POSSIBLE_GRAPH_CONNECTIVITY_DIAGNOSIS_SCHEMA_VERSION,
    ...
    diagnose_phase2_connectivity_witness, diagnose_phase2_possible_graph_connectivity,
    diagnose_phase2_reference_ablation, diagnose_phase2_route_cell_breakdown,
    diagnose_phase2_routing_state_breakdown, diagnose_prior_input_pair_root_snapshot,
    diagnose_prior_input_port_controls, diagnose_prior_input_port_pair_portfolio,
    diagnose_prior_port_subset_ablation, diagnose_prior_source_port_portfolio,
    diagnose_prior_terminal_completion_portfolio, diagnose_prior_terminal_pair_value_portfolio,
    diagnose_residual_facility_port_tuple_portfolio, diagnose_residual_facility_state_ablation,
