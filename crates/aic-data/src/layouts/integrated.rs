...
pub use research::{
    ...
    POSSIBLE_GRAPH_CONNECTIVITY_DIAGNOSIS_SCHEMA_VERSION, PRIOR_INPUT_PORT_CONTROLS_SCHEMA_VERSION,
    ...
    PriorInputPortControlsReport, PriorPortSubsetAblationReport, PriorPortSubsetCaseReport,
    PriorPortSubsetFacility, PriorSourcePortCaseReport, PriorSourcePortParentReport,
    PriorSourcePortPortfolioReport, PriorTerminalCompletionCaseReport,
    ...
    diagnose_prior_input_port_controls, diagnose_prior_port_subset_ablation,
