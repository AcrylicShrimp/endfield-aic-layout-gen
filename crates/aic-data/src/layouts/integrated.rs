...
pub use research::{
    ...
    PRIOR_PORT_SUBSET_ABLATION_SCHEMA_VERSION, PRIOR_TERMINAL_COMPLETION_PORTFOLIO_SCHEMA_VERSION,
    ...
    diagnose_prior_port_subset_ablation, diagnose_prior_terminal_completion_portfolio,
    diagnose_prior_terminal_pair_value_portfolio, diagnose_residual_facility_state_ablation,
