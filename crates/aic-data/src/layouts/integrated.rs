...
pub use research::{
    ...
    ParallelExactDimensionSweepReport, SEARCH_MODE_DIAGNOSIS_SCHEMA_VERSION,
    ...
    diagnose_cumulative_facility_coordinate_partitions, solve_cumulative_scc_growth_v2,
