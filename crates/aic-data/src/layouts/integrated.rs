...
pub use research::{
    ...
    ExactDimensionLowerBoundsReport, ExactDimensionPartitionCaseReport, ExactDimensionSolverStack,
    ...
    PRIOR_PORT_SUBSET_ABLATION_SCHEMA_VERSION, PRIOR_TERMINAL_PAIR_VALUE_PORTFOLIO_SCHEMA_VERSION,
    ...
    PossibleGraphConnectivityScale, PriorPortSubsetAblationReport, PriorPortSubsetCaseReport,
    PriorPortSubsetFacility, PriorTerminalPairDomain, PriorTerminalPairValueCaseReport,
    PriorTerminalPairValuePortfolioReport, PriorTerminalSubsetPartition,
    PriorTerminalSubsetTerminal, RESIDUAL_FACILITY_STATE_ABLATION_SCHEMA_VERSION,
    ROUTE_CELL_BREAKDOWN_SCHEMA_VERSION, ROUTING_STATE_BREAKDOWN_SCHEMA_VERSION,
    ResidualFacilityStateAblationReport, ResidualFacilityStateCaseKind,
    ResidualFacilityStateCaseReport, RouteCellBreakdownCaseReport, RouteCellBreakdownReport,
    ...
    TransportTileCapDiagnosisReport, compare_first_integrated_layout_phase_factored_endpoints,
    ...
    diagnose_prior_port_subset_ablation, diagnose_prior_terminal_pair_value_portfolio,
