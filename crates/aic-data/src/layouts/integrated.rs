...
pub use research::{
    ...
    PRIOR_PORT_SUBSET_ABLATION_SCHEMA_VERSION, ParallelExactDimensionCaseReport,
    ...
    diagnose_prior_port_subset_ablation, diagnose_residual_facility_state_ablation,
